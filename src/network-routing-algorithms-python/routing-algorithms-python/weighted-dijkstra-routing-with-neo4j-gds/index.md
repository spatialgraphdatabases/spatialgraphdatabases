...
<svg viewBox="0 0 764 356" role="img" aria-labelledby="gds-dij-title gds-dij-desc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <text x="600" y="153" text-anchor="middle" font-size="9.5" font-weight="700" fill="#ffffff">S</text>
