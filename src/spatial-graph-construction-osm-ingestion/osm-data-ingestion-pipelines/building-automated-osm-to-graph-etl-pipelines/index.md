...
<svg viewBox="0 0 960 300" role="img" aria-labelledby="etl-title etl-desc" xmlns="http://www.w3.org/2000/svg">
  ...
  <style>
    ...
    .etl-box{fill:var(--surface-1,#ffffff);stroke:var(--line-strong,#9ca3af);stroke-width:1.5;}
    .etl-acc{fill:var(--surface-1,#ffffff);stroke:var(--accent,#0e7c86);stroke-width:2.5;}
