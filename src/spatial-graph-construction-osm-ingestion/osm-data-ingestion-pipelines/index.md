...
<svg viewBox="0 0 900 230" role="img" aria-labelledby="pl-title pl-desc" xmlns="http://www.w3.org/2000/svg">
  ...
  <text class="pl-phase" x="147" y="24" text-anchor="middle" fill="var(--line-strong,#9ca3af)">EXTRACT</text>
  <text class="pl-phase" x="443" y="24" text-anchor="middle" fill="var(--accent,#0e7c86)">TRANSFORM</text>
  <text class="pl-phase" x="739" y="24" text-anchor="middle" fill="#c2410c">LOAD</text>
  ...
  <path class="pl-bracket" stroke="#c2410c" d="M608 40 v-6 h262 v6"/>
  <!-- stage boxes -->
  <g>
  ...
  <text class="pl-res" x="147" y="186" text-anchor="middle" fill="var(--line-strong,#9ca3af)">disk-I/O bound</text>
  <text class="pl-res" x="443" y="186" text-anchor="middle" fill="var(--accent,#0e7c86)">CPU bound</text>
  <text class="pl-res" x="739" y="186" text-anchor="middle" fill="#c2410c">network bound</text>
</svg>
