...
<svg viewBox="0 0 960 420" role="img" aria-labelledby="as-title as-desc" xmlns="http://www.w3.org/2000/svg">
  ...
  <style>
    ...
    .as-box{fill:var(--surface-1,#ffffff);stroke:var(--line-strong,#9ca3af);stroke-width:1.5;}
    .as-feed{fill:var(--surface-2,#f4f4f5);stroke:var(--line-strong,#9ca3af);stroke-width:1.5;}
    .as-acc{fill:var(--surface-1,#ffffff);stroke:var(--accent,#0e7c86);stroke-width:2.5;}
    ...
    .as-node{fill:var(--surface-1,#ffffff);stroke:var(--accent,#0e7c86);stroke-width:2;}
