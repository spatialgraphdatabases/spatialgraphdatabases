...
<svg viewBox="0 0 912 380" role="img" aria-labelledby="ab-title ab-desc" xmlns="http://www.w3.org/2000/svg">
  ...
  <style>
    ...
    .ab-w{fill:var(--surface-1,#ffffff);stroke:var(--accent,#0e7c86);stroke-width:2;}
    .ab-gate{fill:var(--surface-1,#ffffff);stroke:var(--accent-violet,#5b21b6);stroke-width:2;}
    .ab-db{fill:var(--surface-1,#ffffff);stroke:var(--accent-coral,#c2410c);stroke-width:2;}
    ...
    .ab-qlbl{font:600 12px var(--font-sans,system-ui,sans-serif);fill:#8a6d00;}
    .ab-glbl{font:600 13px var(--font-sans,system-ui,sans-serif);fill:var(--accent-violet,#5b21b6);}
  ...
  <line class="ab-flow" x1="536" y1="152" x2="610" y2="206" marker-end="url(#ab-arr)"/>
  <line class="ab-flow" x1="536" y1="212" x2="608" y2="212" marker-end="url(#ab-arr)"/>
  <line class="ab-flow" x1="536" y1="272" x2="610" y2="218" marker-end="url(#ab-arr)"/>
  <!-- graph database -->
