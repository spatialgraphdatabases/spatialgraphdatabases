...
<svg viewBox="0 0 900 420" role="img" aria-labelledby="gk-title gk-desc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <rect class="viz-backdrop" x="0" y="0" width="900" height="420" fill="var(--viz-bg,#ffffff)"/>
...
<svg viewBox="0 0 780 352" role="img" aria-labelledby="kaTitle kaDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="kaTitle">gds.knn and the bounded-radius seek compared on the three axes that decide between them</title>
  <desc id="kaDesc">A comparison matrix. On when the work runs, gds.knn is a scheduled batch that touches the whole graph and leaves a NEAR edge per node, so reads are a single hop; the bounded seek does the work per request against the point index. On what geometry is measured, gds.knn applies a Euclidean metric to the raw latitude-longitude vector, a flat-plane approximation in degree space; the bounded seek calls point.distance for true ellipsoidal metres. On exactness, gds.knn is an approximate NN-descent that samples candidate pairs and can miss a genuine neighbour at production sample rates; the bounded seek is exact within its radius by construction.</desc>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="352" fill="var(--viz-bg,#ffffff)"/>
  <text x="24" y="24" font-size="13.5" font-weight="700" fill="currentColor">Three axes, and they do not all point the same way</text>
  <text x="346" y="58" text-anchor="middle" font-size="12" font-weight="700" fill="var(--accent-3,#5b21b6)">gds.knn</text>
  <text x="346" y="74" text-anchor="middle" font-size="9.5" fill="var(--viz-ink-mute,#565f6d)">precomputed neighbour graph</text>
  <text x="608" y="58" text-anchor="middle" font-size="12" font-weight="700" fill="var(--accent,#0a656d)">bounded-radius seek</text>
  <text x="608" y="74" text-anchor="middle" font-size="9.5" fill="var(--viz-ink-mute,#565f6d)">live single-origin lookup</text>
  <rect x="24" y="86" width="732" height="76" rx="9" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke-soft,#cdc6b3)" stroke-width="1.2"/>
  <text x="42" y="112" font-size="12" font-weight="700" fill="currentColor">when the work runs</text>
  <text x="42" y="132" font-size="10" fill="var(--viz-ink-mute,#565f6d)">request latency vs. staleness</text>
  <rect x="234" y="98" width="224" height="24" rx="12" fill="var(--viz-ok,#7d6200)"/>
  <text x="346" y="115" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">batch job over the whole graph</text>
  <text x="346" y="140" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">reads are one hop · answer ages</text>
  <rect x="496" y="98" width="224" height="24" rx="12" fill="var(--viz-good,#0a656d)"/>
  <text x="608" y="115" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">per request, against the index</text>
  <text x="608" y="140" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">always current · pays per call</text>
  <rect x="24" y="170" width="732" height="76" rx="9" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke-soft,#cdc6b3)" stroke-width="1.2"/>
  <text x="42" y="196" font-size="12" font-weight="700" fill="currentColor">what geometry is measured</text>
  <text x="42" y="216" font-size="10" fill="var(--viz-ink-mute,#565f6d)">degrees vs. metres</text>
  <rect x="234" y="182" width="224" height="24" rx="12" fill="var(--viz-poor,#a8320f)"/>
  <text x="346" y="199" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">EUCLIDEAN over [lat, lon]</text>
  <text x="346" y="224" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">flat plane · drifts away from the equator</text>
  <rect x="496" y="182" width="224" height="24" rx="12" fill="var(--viz-good,#0a656d)"/>
  <text x="608" y="199" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">point.distance()</text>
  <text x="608" y="224" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">true ellipsoidal metres</text>
  <rect x="24" y="254" width="732" height="76" rx="9" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke-soft,#cdc6b3)" stroke-width="1.2"/>
  <text x="42" y="280" font-size="12" font-weight="700" fill="currentColor">how exact the answer is</text>
  <text x="42" y="300" font-size="10" fill="var(--viz-ink-mute,#565f6d)">sampling vs. construction</text>
  <rect x="234" y="266" width="224" height="24" rx="12" fill="var(--viz-ok,#7d6200)"/>
  <text x="346" y="283" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">approximate NN-descent</text>
  <text x="346" y="308" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">at sampleRate 0.5 a near pair can go uncompared</text>
  <rect x="496" y="266" width="224" height="24" rx="12" fill="var(--viz-good,#0a656d)"/>
  <text x="608" y="283" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">exact within the radius</text>
  <text x="608" y="308" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">nothing inside the box is skipped</text>
</svg>
