...
<svg viewBox="0 0 720 410" role="img" aria-labelledby="havTitle havDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <rect class="viz-backdrop" x="0" y="0" width="720" height="410" fill="var(--viz-bg,#ffffff)"/>
  ...
  <text x="60" y="154" text-anchor="middle" font-size="11" font-weight="700" fill="var(--viz-on-pill,#ffffff)">S</text>
  ...
  <text x="215" y="154" text-anchor="middle" font-size="11" font-weight="700" fill="var(--viz-bg,#ffffff)">n1</text>
  ...
  <text x="370" y="154" text-anchor="middle" font-size="11" font-weight="700" fill="var(--viz-bg,#ffffff)">n2</text>
  ...
  <text x="560" y="244" text-anchor="middle" font-size="10" font-weight="700" fill="var(--viz-on-pill,#ffffff)">end</text>
...
<svg viewBox="0 0 780 306" role="img" aria-labelledby="hnTitle hnDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="hnTitle">How one mixed-CRS hop silently deletes a whole path</title>
  <desc id="hnDesc">A four-hop path accumulated by reduce. The first, second and fourth hops join two geographic points and return metre distances of 820, 1140 and 640. The third hop joins a geographic point to a Cartesian one, so point.distance returns null across the two spatial reference systems. Adding null to a running total yields null, so the accumulator is null from that hop onward and the path fails the WHERE comparison — it is dropped from the result rather than reported as an error.</desc>
  <defs>
    <marker id="hn-a" viewBox="0 0 10 10" refX="8.5" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
      <path d="M0 0 L10 5 L0 10 z" fill="currentColor"/>
    </marker>
  </defs>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="306" fill="var(--viz-bg,#ffffff)"/>
  <text x="24" y="24" font-size="13.5" font-weight="700" fill="currentColor">One null term poisons the accumulator for the rest of the path</text>
  <text x="24" y="42" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">reduce(c = 0.0, r IN relationships(path) | c + point.distance(…))</text>
  <g font-size="11" font-weight="700" text-anchor="middle">
    <circle cx="80" cy="104" r="19" fill="var(--accent,#0a656d)"/><text x="80" y="108" fill="var(--viz-on-pill,#ffffff)">n1</text>
    <circle cx="240" cy="104" r="19" fill="var(--accent,#0a656d)"/><text x="240" y="108" fill="var(--viz-on-pill,#ffffff)">n2</text>
    <circle cx="400" cy="104" r="19" fill="var(--accent,#0a656d)"/><text x="400" y="108" fill="var(--viz-on-pill,#ffffff)">n3</text>
    <circle cx="560" cy="104" r="19" fill="var(--viz-poor,#a8320f)"/><text x="560" y="108" fill="var(--viz-on-pill,#ffffff)">n4</text>
    <circle cx="716" cy="104" r="19" fill="var(--accent,#0a656d)"/><text x="716" y="108" fill="var(--viz-on-pill,#ffffff)">n5</text>
  </g>
  <g stroke="currentColor" stroke-width="1.8" marker-end="url(#hn-a)">
    <line x1="100" y1="104" x2="217" y2="104"/>
    <line x1="260" y1="104" x2="377" y2="104"/>
    <line x1="580" y1="104" x2="693" y2="104"/>
  </g>
  <line x1="420" y1="104" x2="537" y2="104" stroke="var(--viz-poor,#a8320f)" stroke-width="2.4" stroke-dasharray="7 5" marker-end="url(#hn-a)"/>
  <g font-size="10" text-anchor="middle" fill="var(--viz-ink-mute,#565f6d)">
    <text x="80" y="140">SRID 4326</text>
    <text x="240" y="140">SRID 4326</text>
    <text x="400" y="140">SRID 4326</text>
    <text x="716" y="140">SRID 4326</text>
  </g>
  <text x="560" y="140" text-anchor="middle" font-size="10" font-weight="700" fill="var(--viz-poor,#a8320f)">SRID 7203</text>
  <text x="560" y="154" text-anchor="middle" font-size="9.5" fill="var(--viz-ink-mute,#565f6d)">point({x, y})</text>
  <g font-size="10.5" text-anchor="middle" font-weight="700">
    <text x="158" y="88" fill="var(--viz-good,#0a656d)">820 m</text>
    <text x="318" y="88" fill="var(--viz-good,#0a656d)">1,140 m</text>
    <text x="478" y="88" fill="var(--viz-poor,#a8320f)">null</text>
    <text x="636" y="88" fill="var(--viz-good,#0a656d)">640 m</text>
  </g>
  <text x="24" y="192" font-size="11" font-weight="700" fill="currentColor">accumulator after each hop</text>
  <g font-size="11" font-weight="700" text-anchor="middle">
    <rect x="24" y="204" width="130" height="34" rx="6" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-good,#0a656d)" stroke-width="1.5"/>
    <text x="89" y="226" fill="currentColor">820.0</text>
    <rect x="184" y="204" width="130" height="34" rx="6" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-good,#0a656d)" stroke-width="1.5"/>
    <text x="249" y="226" fill="currentColor">1960.0</text>
    <rect x="344" y="204" width="130" height="34" rx="6" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-poor,#a8320f)" stroke-width="2"/>
    <text x="409" y="226" fill="var(--viz-poor,#a8320f)">null</text>
    <rect x="504" y="204" width="130" height="34" rx="6" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-poor,#a8320f)" stroke-width="2"/>
    <text x="569" y="226" fill="var(--viz-poor,#a8320f)">null</text>
    <rect x="664" y="204" width="92" height="34" rx="6" fill="var(--viz-poor,#a8320f)"/>
    <text x="710" y="226" fill="var(--viz-on-pill,#ffffff)">dropped</text>
  </g>
  <text x="24" y="270" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">null &#8804; $max_meters is null, not false, so the row never reaches the result — no error, no warning, one path</text>
  <text x="24" y="286" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">quietly missing. Assert SRID consistency at ingestion; coalesce only tells you how many hops are broken.</text>
</svg>
...
Two operational notes follow from that cost shape. First, the `*1..8` bound is doing more work than it appears to: it is not a convenience limit but the only thing standing between a dense urban subgraph and a combinatorial expansion, and lowering it by a single hop can cut the surviving-path count by close to an order of magnitude on a well-connected grid. Choose it from the geography rather than from habit — eight hops means something quite different in a suburban network with an average degree near two than in a city centre where it is closer to four.

Second, this filter answers a question about *reachability within a distance budget*, and it is worth being explicit that the budget is cumulative edge length, not displacement. A path that doubles back on itself accrues length without covering ground, so a generous threshold admits routes that are geometrically close to the origin but expensive to drive. Where the intent is really "within a radius", clip the endpoints with a bounding-box seek first and let this accumulator refine what survives; where the intent is genuinely "no more than this much driving", the accumulator is the right primitive and the bound should be read as a fuel or time budget rather than as a search radius.
