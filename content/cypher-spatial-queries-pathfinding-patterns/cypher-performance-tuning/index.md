...
<svg viewBox="0 0 820 440" role="img" aria-labelledby="pp-title pp-desc" xmlns="http://www.w3.org/2000/svg">
  ...
  <style>
    ...
    .pp-pill{font:700 11px var(--font-sans,system-ui,sans-serif);fill:var(--viz-on-pill,#ffffff);}
  ...
  <!-- TUNED LANE -->
  <rect class="viz-backdrop" x="0" y="0" width="820" height="440" fill="var(--viz-bg,#ffffff)"/>
  <text class="pp-lane pp-good" x="12" y="40" style="fill:var(--accent,#0e7c86)">Index-first (tuned)</text>
  ...
  <!-- ANTI-PATTERN LANE -->
  <text class="pp-lane pp-bad" x="12" y="290" style="fill:var(--viz-poor,#a8320f)">Scan-then-filter (anti-pattern)</text>
...
<svg viewBox="0 0 780 396" role="img" aria-labelledby="pdTitle pdDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="pdTitle">Where the spatial predicate sits decides what the planner can prune</title>
  <desc id="pdDesc">Two operator stacks for the same query. On the left the spatial predicate sits inside the shortestPath pattern: the anchor MATCH resolves by label scan, the expansion opens a wide frontier, shortestPath materialises partial routes, and only then is the geometry tested — so the filter discards work the engine already paid for. On the right the same predicate is pushed onto the anchor MATCH: a PointIndexSeekByRange resolves anchors first, the frontier entering shortestPath is small, and the filter never has to undo completed work.</desc>
  <defs>
    <marker id="pd-arr" viewBox="0 0 10 10" refX="8.5" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
      <path d="M0 0 L10 5 L0 10 z" fill="currentColor"/>
    </marker>
  </defs>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="396" fill="var(--viz-bg,#ffffff)"/>
  <text x="192" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">Predicate inside shortestPath</text>
  <text x="192" y="42" text-anchor="middle" font-size="10.5" fill="var(--viz-poor,#a8320f)" font-weight="600">geometry tested after the paths are built</text>
  <text x="588" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">Predicate pushed onto the anchor</text>
  <text x="588" y="42" text-anchor="middle" font-size="10.5" fill="var(--viz-good,#0a656d)" font-weight="600">geometry bounds the frontier first</text>
  <line x1="390" y1="58" x2="390" y2="372" stroke="var(--line,#e5e0d2)" stroke-width="1" stroke-dasharray="3 6"/>
  <!-- LEFT stack -->
  <rect x="60" y="62" width="264" height="42" rx="8" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-poor,#a8320f)" stroke-width="1.6"/>
  <text x="192" y="80" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">NodeByLabelScan</text>
  <text x="192" y="96" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">every :Junction read</text>
  <line x1="192" y1="104" x2="192" y2="126" stroke="currentColor" stroke-width="1.6" marker-end="url(#pd-arr)"/>
  <rect x="60" y="128" width="264" height="42" rx="8" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.4"/>
  <text x="192" y="146" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">Expand(All)</text>
  <text x="192" y="162" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">frontier grows unbounded</text>
  <line x1="192" y1="170" x2="192" y2="192" stroke="currentColor" stroke-width="1.6" marker-end="url(#pd-arr)"/>
  <rect x="60" y="194" width="264" height="42" rx="8" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.4"/>
  <text x="192" y="212" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">shortestPath</text>
  <text x="192" y="228" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">partial routes buffered on heap</text>
  <line x1="192" y1="236" x2="192" y2="258" stroke="currentColor" stroke-width="1.6" marker-end="url(#pd-arr)"/>
  <rect x="60" y="260" width="264" height="42" rx="8" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-poor,#a8320f)" stroke-width="2"/>
  <text x="192" y="278" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-poor,#a8320f)">Filter: point.distance()</text>
  <text x="192" y="294" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">discards work already paid for</text>
  <rect x="60" y="322" width="264" height="46" rx="8" fill="var(--viz-panel-2,#ece9df)" stroke="var(--viz-stroke-soft,#cdc6b3)" stroke-width="1.2"/>
  <text x="76" y="341" font-size="10.5" font-weight="700" fill="currentColor">heap</text>
  <rect x="120" y="331" width="188" height="12" rx="6" fill="var(--viz-poor,#a8320f)"/>
  <text x="76" y="360" font-size="10.5" font-weight="700" fill="currentColor">rows</text>
  <rect x="120" y="350" width="188" height="12" rx="6" fill="var(--viz-poor,#a8320f)"/>
  <!-- RIGHT stack -->
  <rect x="456" y="62" width="264" height="42" rx="8" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-good,#0a656d)" stroke-width="2"/>
  <text x="588" y="80" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-good,#0a656d)">PointIndexSeekByRange</text>
  <text x="588" y="96" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">bounding box resolves anchors</text>
  <line x1="588" y1="104" x2="588" y2="126" stroke="currentColor" stroke-width="1.6" marker-end="url(#pd-arr)"/>
  <rect x="456" y="128" width="264" height="42" rx="8" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.4"/>
  <text x="588" y="146" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">Filter: point.distance()</text>
  <text x="588" y="162" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">exact clip on a few hundred rows</text>
  <line x1="588" y1="170" x2="588" y2="192" stroke="currentColor" stroke-width="1.6" marker-end="url(#pd-arr)"/>
  <rect x="456" y="194" width="264" height="42" rx="8" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.4"/>
  <text x="588" y="212" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">Expand(Into)</text>
  <text x="588" y="228" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">frontier already bounded</text>
  <line x1="588" y1="236" x2="588" y2="258" stroke="currentColor" stroke-width="1.6" marker-end="url(#pd-arr)"/>
  <rect x="456" y="260" width="264" height="42" rx="8" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-good,#0a656d)" stroke-width="1.6"/>
  <text x="588" y="278" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">shortestPath</text>
  <text x="588" y="294" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">no route is built to be thrown away</text>
  <rect x="456" y="322" width="264" height="46" rx="8" fill="var(--viz-panel-2,#ece9df)" stroke="var(--viz-stroke-soft,#cdc6b3)" stroke-width="1.2"/>
  <text x="472" y="341" font-size="10.5" font-weight="700" fill="currentColor">heap</text>
  <rect x="516" y="331" width="34" height="12" rx="6" fill="var(--viz-good,#0a656d)"/>
  <text x="472" y="360" font-size="10.5" font-weight="700" fill="currentColor">rows</text>
  <rect x="516" y="350" width="26" height="12" rx="6" fill="var(--viz-good,#0a656d)"/>
</svg>
