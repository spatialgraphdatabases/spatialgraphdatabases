...
<svg viewBox="0 0 720 440" role="img" aria-labelledby="isoTitle isoDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <!-- rings -->
  <rect class="viz-backdrop" x="0" y="0" width="720" height="440" fill="var(--viz-bg,#ffffff)"/>
  ...
  <text x="250" y="229" text-anchor="middle" font-size="11" font-weight="700" fill="var(--viz-on-pill,#ffffff)">S</text>
...
<svg viewBox="0 0 760 372" role="img" aria-labelledby="hullTitle hullDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <g>
    ...
    <text x="150" y="163" text-anchor="middle" font-size="8.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">S</text>
  </g>
  <!-- arrow -->
  ...
  <g>
    ...
    <text x="520" y="163" text-anchor="middle" font-size="8.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">S</text>
  </g>
