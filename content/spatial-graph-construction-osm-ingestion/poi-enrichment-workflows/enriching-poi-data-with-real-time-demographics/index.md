...
<svg viewBox="0 0 980 452" role="img" aria-labelledby="pe-title pe-desc" xmlns="http://www.w3.org/2000/svg">
  ...
  <style>
    ...
    .pe-box{fill:var(--viz-panel,#f4f4f5);stroke:var(--accent,#0e7c86);stroke-width:2;}
    ...
    .pe-db{fill:var(--viz-panel,#f4f4f5);stroke:var(--accent,#0e7c86);stroke-width:2.5;}
  </style>
  <defs>
  ...
  <!-- column headers -->
  <rect class="viz-backdrop" x="0" y="0" width="980" height="452" fill="var(--viz-bg,#ffffff)"/>
...
<svg viewBox="0 0 780 316" role="img" aria-labelledby="phTitle phDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="phTitle">Partitioning writes by hexagon serialises the updates that would have contended</title>
  <desc id="phDesc">Left: unpartitioned flushing. Four concurrent batches each contain updates for POIs in the same dense block, so all four transactions reach for the same high-degree nodes and two of them abort with a deadlock and retry. Right: the same updates bucketed by H3 cell before flushing. Co-located updates land in one buffer and commit as a single transaction, while the three other cells flush concurrently under the semaphore, so no two in-flight transactions want the same node.</desc>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="316" fill="var(--viz-bg,#ffffff)"/>
  <text x="196" y="24" text-anchor="middle" font-size="13" font-weight="700" fill="var(--viz-poor,#a8320f)">flushed as they arrive</text>
  <text x="584" y="24" text-anchor="middle" font-size="13" font-weight="700" fill="var(--viz-good,#0a656d)">bucketed by H3 cell first</text>
  <line x1="390" y1="40" x2="390" y2="278" stroke="var(--line,#e5e0d2)" stroke-width="1" stroke-dasharray="3 6"/>
  <rect x="24" y="44" width="336" height="222" rx="10" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.2"/>
  <g font-size="10" text-anchor="middle" font-weight="700">
    <rect x="44" y="62" width="68" height="24" rx="6" fill="var(--accent-3,#5b21b6)"/><text x="78" y="79" fill="var(--viz-on-pill,#ffffff)">batch 1</text>
    <rect x="120" y="62" width="68" height="24" rx="6" fill="var(--accent-3,#5b21b6)"/><text x="154" y="79" fill="var(--viz-on-pill,#ffffff)">batch 2</text>
    <rect x="196" y="62" width="68" height="24" rx="6" fill="var(--accent-3,#5b21b6)"/><text x="230" y="79" fill="var(--viz-on-pill,#ffffff)">batch 3</text>
    <rect x="272" y="62" width="68" height="24" rx="6" fill="var(--accent-3,#5b21b6)"/><text x="306" y="79" fill="var(--viz-on-pill,#ffffff)">batch 4</text>
  </g>
  <g stroke="var(--viz-poor,#a8320f)" stroke-width="1.5">
    <line x1="78" y1="86" x2="180" y2="140"/><line x1="154" y1="86" x2="186" y2="140"/>
    <line x1="230" y1="86" x2="198" y2="140"/><line x1="306" y1="86" x2="204" y2="140"/>
  </g>
  <circle cx="192" cy="154" r="16" fill="var(--viz-poor,#a8320f)"/>
  <text x="192" y="158" text-anchor="middle" font-size="9.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">hot</text>
  <text x="192" y="192" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-poor,#a8320f)">four transactions, one lock</text>
  <text x="192" y="210" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">two abort with DeadlockDetected</text>
  <text x="192" y="226" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">retried work is repeated work</text>
  <text x="192" y="250" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">throughput falls as density rises</text>
  <rect x="420" y="44" width="336" height="222" rx="10" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.2"/>
  <g font-size="10" text-anchor="middle" font-weight="700">
    <rect x="440" y="62" width="68" height="24" rx="6" fill="var(--viz-good,#0a656d)"/><text x="474" y="79" fill="var(--viz-on-pill,#ffffff)">cell A</text>
    <rect x="516" y="62" width="68" height="24" rx="6" fill="var(--viz-good,#0a656d)"/><text x="550" y="79" fill="var(--viz-on-pill,#ffffff)">cell B</text>
    <rect x="592" y="62" width="68" height="24" rx="6" fill="var(--viz-good,#0a656d)"/><text x="626" y="79" fill="var(--viz-on-pill,#ffffff)">cell C</text>
    <rect x="668" y="62" width="68" height="24" rx="6" fill="var(--viz-good,#0a656d)"/><text x="702" y="79" fill="var(--viz-on-pill,#ffffff)">cell D</text>
  </g>
  <g stroke="var(--viz-good,#0a656d)" stroke-width="1.5">
    <line x1="474" y1="86" x2="474" y2="140"/><line x1="550" y1="86" x2="550" y2="140"/>
    <line x1="626" y1="86" x2="626" y2="140"/><line x1="702" y1="86" x2="702" y2="140"/>
  </g>
  <g font-size="9.5" text-anchor="middle" font-weight="700">
    <circle cx="474" cy="154" r="14" fill="var(--accent,#0a656d)"/><text x="474" y="158" fill="var(--viz-on-pill,#ffffff)">tx</text>
    <circle cx="550" cy="154" r="14" fill="var(--accent,#0a656d)"/><text x="550" y="158" fill="var(--viz-on-pill,#ffffff)">tx</text>
    <circle cx="626" cy="154" r="14" fill="var(--accent,#0a656d)"/><text x="626" y="158" fill="var(--viz-on-pill,#ffffff)">tx</text>
    <circle cx="702" cy="154" r="14" fill="var(--accent,#0a656d)"/><text x="702" y="158" fill="var(--viz-on-pill,#ffffff)">tx</text>
  </g>
  <text x="588" y="192" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-good,#0a656d)">disjoint node sets by construction</text>
  <text x="588" y="210" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">co-located updates share one transaction</text>
  <text x="588" y="226" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">distinct cells run concurrently</text>
  <text x="588" y="250" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">throughput is flat in density</text>
  <text x="24" y="296" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">Validation runs before the cell is computed, so a malformed coordinate cannot land in the wrong bucket or raise</text>
  <text x="24" y="312" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">inside the H3 call — the partition key is only as trustworthy as the coordinate it was derived from.</text>
</svg>
