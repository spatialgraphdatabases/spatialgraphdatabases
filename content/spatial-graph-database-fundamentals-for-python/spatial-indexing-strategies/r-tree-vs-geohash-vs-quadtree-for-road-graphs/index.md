...
<svg viewBox="0 0 720 404" role="img" aria-labelledby="mtxTitle mtxDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <text x="326" y="129" text-anchor="middle" font-size="11.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">&#10003; best</text>
  ...
  <text x="326" y="185" text-anchor="middle" font-size="11.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">&#10003; best</text>
  ...
  <text x="478" y="241" text-anchor="middle" font-size="11.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">&#10003; best</text>
  ...
  <text x="478" y="297" text-anchor="middle" font-size="11.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">&#10003; best</text>
  ...
  <text x="630" y="353" text-anchor="middle" font-size="11.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">&#10003; best</text>
...
<svg viewBox="0 0 780 300" role="img" aria-labelledby="irTitle irDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="irTitle">A prefix ring is a fixed shape; the query radius is not</title>
  <desc id="irDesc">The same nearest-hub query answered two ways. The geohash approach fetches the home cell and its eight neighbours, over-fetching a square region far larger than the radius, and still misses a hub that lies inside the radius but two cells away because the radius exceeds one cell edge. The R-tree seeks the bounding box of the radius directly, clips to the circle and applies the limit, so it reads less and cannot miss a candidate the radius covers.</desc>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="300" fill="var(--viz-bg,#ffffff)"/>
  <text x="196" y="24" text-anchor="middle" font-size="13" font-weight="700" fill="var(--viz-poor,#a8320f)">geohash 3 × 3 ring</text>
  <text x="584" y="24" text-anchor="middle" font-size="13" font-weight="700" fill="var(--viz-good,#0a656d)">point index seek</text>
  <line x1="390" y1="38" x2="390" y2="256" stroke="var(--line,#e5e0d2)" stroke-width="1" stroke-dasharray="3 6"/>
  <rect x="24" y="42" width="336" height="204" rx="10" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.2"/>
  <rect x="96" y="72" width="192" height="144" fill="var(--viz-poor,#a8320f)" opacity="0.12"/>
  <g stroke="var(--viz-stroke-soft,#cdc6b3)" stroke-width="1">
    <line x1="160" y1="72" x2="160" y2="216"/><line x1="224" y1="72" x2="224" y2="216"/>
    <line x1="96" y1="120" x2="288" y2="120"/><line x1="96" y1="168" x2="288" y2="168"/>
  </g>
  <rect x="96" y="72" width="192" height="144" fill="none" stroke="var(--viz-poor,#a8320f)" stroke-width="1.8"/>
  <circle cx="192" cy="144" r="58" fill="none" stroke="var(--accent-3,#5b21b6)" stroke-width="1.8" stroke-dasharray="6 4"/>
  <circle cx="192" cy="144" r="6" fill="var(--accent-3,#5b21b6)"/>
  <g fill="var(--viz-poor,#a8320f)">
    <circle cx="120" cy="96" r="4"/><circle cx="264" cy="100" r="4"/><circle cx="132" cy="196" r="4"/><circle cx="258" cy="192" r="4"/>
    <circle cx="112" cy="148" r="4"/><circle cx="272" cy="152" r="4"/>
  </g>
  <g fill="var(--viz-good,#0a656d)">
    <circle cx="176" cy="112" r="4"/><circle cx="216" cy="164" r="4"/><circle cx="164" cy="176" r="4"/>
  </g>
  <circle cx="316" cy="132" r="5" fill="var(--viz-poor,#a8320f)"/>
  <text x="196" y="266" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">9 cells read · 6 discarded client-side</text>
  <rect x="412" y="42" width="336" height="204" rx="10" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.2"/>
  <rect x="522" y="86" width="116" height="116" fill="var(--viz-good,#0a656d)" opacity="0.14"/>
  <rect x="522" y="86" width="116" height="116" fill="none" stroke="var(--viz-good,#0a656d)" stroke-width="1.8"/>
  <circle cx="580" cy="144" r="58" fill="none" stroke="var(--accent-3,#5b21b6)" stroke-width="1.8" stroke-dasharray="6 4"/>
  <circle cx="580" cy="144" r="6" fill="var(--accent-3,#5b21b6)"/>
  <g fill="var(--viz-good,#0a656d)">
    <circle cx="564" cy="112" r="4"/><circle cx="604" cy="164" r="4"/><circle cx="552" cy="176" r="4"/>
  </g>
  <g fill="var(--viz-stroke,#9ca3af)" opacity="0.55">
    <circle cx="508" cy="96" r="4"/><circle cx="652" cy="100" r="4"/><circle cx="520" cy="196" r="4"/><circle cx="646" cy="192" r="4"/>
    <circle cx="500" cy="148" r="4"/><circle cx="660" cy="152" r="4"/><circle cx="704" cy="132" r="4"/>
  </g>
  <text x="584" y="266" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">one seek sized to the radius · no merge step</text>
  <text x="24" y="290" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">The hub outside the ring is inside the radius. Widening the ring is not a fix — it only moves the boundary the next query crosses.</text>
</svg>
