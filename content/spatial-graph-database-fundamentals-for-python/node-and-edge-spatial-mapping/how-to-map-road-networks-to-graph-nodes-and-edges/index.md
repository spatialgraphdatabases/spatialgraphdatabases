...
<svg viewBox="0 0 840 372" role="img" aria-labelledby="pipeTitle pipeDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <!-- panel separators -->
  <rect class="viz-backdrop" x="0" y="0" width="840" height="372" fill="var(--viz-bg,#ffffff)"/>
  ...
  <g font-size="11" font-weight="700" text-anchor="middle">
    ...
    <circle cx="720" cy="165" r="15" fill="var(--accent,#0e7c86)"/><text x="720" y="169" fill="var(--viz-on-pill,#ffffff)">4</text>
  </g>
...
<svg viewBox="0 0 780 300" role="img" aria-labelledby="mdTitle mdDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="mdTitle">The degree histogram tells you which build went wrong before anything is persisted</title>
  <desc id="mdDesc">Node degree distributions for the same extract built twice. The healthy build has no degree-zero nodes, a small tail of degree-one dead ends, and most mass at degrees two to four. The build with mismatched rounding has the same edge count but a spike of degree-zero isolated nodes and roughly twice as many degree-one nodes, because each intersection that fragmented into two keys left both halves under-connected. Degree zero is always an error; degree one is ambiguous, since a genuine cul-de-sac looks identical, which is why the assertion fails on isolated nodes and only reports dangling ones.</desc>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="300" fill="var(--viz-bg,#ffffff)"/>
  <text x="24" y="24" font-size="13.5" font-weight="700" fill="currentColor">Degree distribution, same extract, two rounding settings</text>
  <line x1="80" y1="60" x2="80" y2="228" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.4"/>
  <line x1="80" y1="228" x2="736" y2="228" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.4"/>
  <text x="36" y="146" font-size="10" font-weight="700" fill="currentColor" transform="rotate(-90 36 146)">nodes</text>
  <g text-anchor="middle" font-size="10" font-weight="700">
    <text x="160" y="248" fill="currentColor">degree 0</text>
    <text x="288" y="248" fill="currentColor">degree 1</text>
    <text x="416" y="248" fill="currentColor">degree 2</text>
    <text x="544" y="248" fill="currentColor">degree 3</text>
    <text x="672" y="248" fill="currentColor">degree 4+</text>
  </g>
  <g>
    <rect x="124" y="228" width="32" height="0" fill="var(--viz-good,#0a656d)"/>
    <rect x="252" y="196" width="32" height="32" rx="2" fill="var(--viz-good,#0a656d)"/>
    <rect x="380" y="96" width="32" height="132" rx="2" fill="var(--viz-good,#0a656d)"/>
    <rect x="508" y="128" width="32" height="100" rx="2" fill="var(--viz-good,#0a656d)"/>
    <rect x="636" y="164" width="32" height="64" rx="2" fill="var(--viz-good,#0a656d)"/>
  </g>
  <g>
    <rect x="162" y="140" width="32" height="88" rx="2" fill="var(--viz-poor,#a8320f)"/>
    <rect x="290" y="164" width="32" height="64" rx="2" fill="var(--viz-poor,#a8320f)"/>
    <rect x="418" y="128" width="32" height="100" rx="2" fill="var(--viz-poor,#a8320f)"/>
    <rect x="546" y="172" width="32" height="56" rx="2" fill="var(--viz-poor,#a8320f)"/>
    <rect x="674" y="196" width="32" height="32" rx="2" fill="var(--viz-poor,#a8320f)"/>
  </g>
  <text x="140" y="208" text-anchor="middle" font-size="9.5" font-weight="700" fill="var(--viz-good,#0a656d)">0</text>
  <line x1="178" y1="136" x2="214" y2="88" stroke="var(--viz-poor,#a8320f)" stroke-width="1.2"/>
  <text x="220" y="84" font-size="10" font-weight="700" fill="var(--viz-poor,#a8320f)">always an error — assert on this</text>
  <line x1="306" y1="160" x2="342" y2="120" stroke="var(--viz-ok,#7d6200)" stroke-width="1.2"/>
  <text x="348" y="116" font-size="10" font-weight="700" fill="var(--viz-ok,#7d6200)">a real cul-de-sac looks the same — report, do not assert</text>
  <rect x="80" y="268" width="14" height="6" rx="3" fill="var(--viz-good,#0a656d)"/>
  <text x="102" y="274" font-size="10" fill="currentColor">consistent rounding</text>
  <rect x="300" y="268" width="14" height="6" rx="3" fill="var(--viz-poor,#a8320f)"/>
  <text x="322" y="274" font-size="10" fill="currentColor">builder and consumer round to different places — same edge count, fragmented topology</text>
</svg>
