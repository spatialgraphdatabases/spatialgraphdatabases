...
<svg viewBox="0 0 880 380" role="img" aria-labelledby="nm-title nm-desc" xmlns="http://www.w3.org/2000/svg">
  ...
  <style>
    ...
    .nm-step{fill:var(--viz-panel,#f4f4f5);stroke:var(--accent,#0e7c86);stroke-width:2;}
    ...
    .nm-node{fill:var(--viz-panel,#f4f4f5);stroke:var(--accent,#0e7c86);stroke-width:2.5;}
  ...
  <rect class="viz-backdrop" x="0" y="0" width="880" height="380" fill="var(--viz-bg,#ffffff)"/>
...
<svg viewBox="0 0 780 296" role="img" aria-labelledby="miTitle miDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="miTitle">Web Mercator inflates length with latitude, so the error rides north with the data</title>
  <desc id="miDesc">The ratio of a Web Mercator planar length to the true geodesic length, plotted against latitude. At the equator the two agree. At 40 degrees the planar figure is about 30 per cent long, at 55 degrees about 74 per cent long, and at 65 degrees more than double. A router minimising the inflated weights does not merely report wrong distances — it prefers east-west edges over north-south ones, because only the north-south component is inflated, so the route itself changes.</desc>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="296" fill="var(--viz-bg,#ffffff)"/>
  <text x="24" y="24" font-size="13.5" font-weight="700" fill="currentColor">EPSG:3857 length ÷ true geodesic length</text>
  <line x1="96" y1="56" x2="96" y2="216" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.4"/>
  <line x1="96" y1="216" x2="700" y2="216" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.4"/>
  <g font-size="9.5" fill="var(--viz-ink-mute,#565f6d)" text-anchor="end">
    <text x="88" y="220">1.0×</text><text x="88" y="180">1.5×</text><text x="88" y="140">2.0×</text><text x="88" y="100">2.5×</text><text x="88" y="60">3.0×</text>
  </g>
  <g font-size="9.5" fill="var(--viz-ink-mute,#565f6d)" text-anchor="middle">
    <text x="96" y="236">0°</text><text x="217" y="236">20°</text><text x="338" y="236">40°</text><text x="459" y="236">55°</text><text x="580" y="236">65°</text><text x="700" y="236">70°</text>
  </g>
  <text x="398" y="256" text-anchor="middle" font-size="10" font-weight="700" fill="currentColor">latitude</text>
  <line x1="96" y1="216" x2="700" y2="216" stroke="var(--viz-good,#0a656d)" stroke-width="1.2" stroke-dasharray="5 4"/>
  <path d="M96 216 L217 209 L338 192 L459 157 L580 96 L700 62" fill="none" stroke="var(--viz-poor,#a8320f)" stroke-width="2.6"/>
  <g fill="var(--viz-poor,#a8320f)">
    <circle cx="338" cy="192" r="5"/><circle cx="459" cy="157" r="5"/><circle cx="580" cy="96" r="5"/>
  </g>
  <text x="338" y="182" text-anchor="middle" font-size="9.5" font-weight="700" fill="var(--viz-poor,#a8320f)">1.30×</text>
  <text x="459" y="147" text-anchor="middle" font-size="9.5" font-weight="700" fill="var(--viz-poor,#a8320f)">1.74×</text>
  <text x="580" y="86" text-anchor="middle" font-size="9.5" font-weight="700" fill="var(--viz-poor,#a8320f)">2.37×</text>
  <text x="24" y="278" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">Only the north-south component is stretched, so the router does not just misreport distance — it starts preferring</text>
  <text x="24" y="294" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">east-west edges. Derive length_m geodesically from the original WGS 84 coordinates and project for display only.</text>
</svg>
