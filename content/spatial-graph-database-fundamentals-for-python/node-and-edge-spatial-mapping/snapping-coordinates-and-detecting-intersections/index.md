...
<svg viewBox="0 0 820 350" role="img" aria-labelledby="snapTitle snapDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <rect class="viz-backdrop" x="0" y="0" width="820" height="350" fill="var(--viz-bg,#ffffff)"/>
...
<svg viewBox="0 0 780 312" role="img" aria-labelledby="sgTitle sgDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="sgTitle">Why the neighbourhood scan is three by three, and not just the home cell</title>
  <desc id="sgDesc">Two points 1.2 metres apart, inside a 1.5 metre tolerance, sitting either side of a cell boundary. Plain rounding assigns them to different cells and, checking only the home cell, never compares them — so they stay two nodes and the junction fragments. Because the cell edge is sized to equal the tolerance, any two points within the tolerance must land in the same or an adjacent cell, so scanning the three by three neighbourhood is guaranteed to find the pair. The scan is not a heuristic widening; it is what makes the cell size a correct index.</desc>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="312" fill="var(--viz-bg,#ffffff)"/>
  <text x="24" y="24" font-size="13.5" font-weight="700" fill="currentColor">Cell edge = tolerance, so a straddling pair is always one cell away</text>
  <text x="24" y="42" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">two endpoints 1.2 m apart · tol_m = 1.5</text>
  <rect x="24" y="58" width="356" height="204" rx="10" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-poor,#a8320f)" stroke-width="1.8"/>
  <text x="202" y="82" text-anchor="middle" font-size="11.5" font-weight="700" fill="var(--viz-poor,#a8320f)">home cell only</text>
  <g stroke="var(--viz-stroke-soft,#cdc6b3)" stroke-width="1">
    <line x1="76" y1="104" x2="328" y2="104"/><line x1="76" y1="160" x2="328" y2="160"/><line x1="76" y1="216" x2="328" y2="216"/>
    <line x1="76" y1="104" x2="76" y2="216"/><line x1="160" y1="104" x2="160" y2="216"/><line x1="244" y1="104" x2="244" y2="216"/><line x1="328" y1="104" x2="328" y2="216"/>
  </g>
  <rect x="76" y="104" width="84" height="56" fill="var(--viz-poor,#a8320f)" opacity="0.12"/>
  <circle cx="150" cy="140" r="6" fill="var(--viz-poor,#a8320f)"/>
  <circle cx="172" cy="140" r="6" fill="var(--viz-poor,#a8320f)"/>
  <text x="202" y="240" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">different cells · never compared</text>
  <text x="202" y="256" text-anchor="middle" font-size="10" font-weight="700" fill="var(--viz-poor,#a8320f)">the junction fragments into two nodes</text>
  <rect x="400" y="58" width="356" height="204" rx="10" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-good,#0a656d)" stroke-width="1.8"/>
  <text x="578" y="82" text-anchor="middle" font-size="11.5" font-weight="700" fill="var(--viz-good,#0a656d)">3 × 3 neighbourhood</text>
  <g stroke="var(--viz-stroke-soft,#cdc6b3)" stroke-width="1">
    <line x1="452" y1="104" x2="704" y2="104"/><line x1="452" y1="160" x2="704" y2="160"/><line x1="452" y1="216" x2="704" y2="216"/>
    <line x1="452" y1="104" x2="452" y2="216"/><line x1="536" y1="104" x2="536" y2="216"/><line x1="620" y1="104" x2="620" y2="216"/><line x1="704" y1="104" x2="704" y2="216"/>
  </g>
  <rect x="452" y="104" width="252" height="112" fill="var(--viz-good,#0a656d)" opacity="0.1"/>
  <rect x="452" y="104" width="252" height="112" fill="none" stroke="var(--viz-good,#0a656d)" stroke-width="1.8" stroke-dasharray="6 4"/>
  <circle cx="526" cy="140" r="6" fill="var(--viz-good,#0a656d)"/>
  <circle cx="548" cy="140" r="6" fill="var(--viz-good,#0a656d)"/>
  <line x1="526" y1="140" x2="548" y2="140" stroke="var(--viz-good,#0a656d)" stroke-width="2"/>
  <text x="578" y="240" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">adjacent cells are in scope · pair found</text>
  <text x="578" y="256" text-anchor="middle" font-size="10" font-weight="700" fill="var(--viz-good,#0a656d)">one node, as the geometry intends</text>
  <text x="24" y="292" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">Sizing the cell from a metric radius rather than a decimal count is what makes this hold at every latitude: 1.5 m is</text>
  <text x="24" y="308" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">1.5 m in London and at the equator, whereas a fixed decimal place is not.</text>
</svg>
