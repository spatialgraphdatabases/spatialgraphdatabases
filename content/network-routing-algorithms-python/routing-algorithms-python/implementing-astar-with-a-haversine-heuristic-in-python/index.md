...
<svg viewBox="0 0 720 404" role="img" aria-labelledby="astar-sets-title astar-sets-desc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <!-- edges -->
  <rect class="viz-backdrop" x="0" y="0" width="720" height="404" fill="var(--viz-bg,#ffffff)"/>
  ...
  <g>
    ...
    <text x="80" y="204" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-on-pill,#ffffff)">S</text>
    <circle cx="220" cy="120" r="15" fill="var(--ink-soft,#455062)"/>
    <text x="220" y="124" text-anchor="middle" font-size="11" font-weight="700" fill="var(--viz-on-pill,#ffffff)">n1</text>
    <circle cx="220" cy="280" r="15" fill="var(--ink-soft,#455062)"/>
    <text x="220" y="284" text-anchor="middle" font-size="11" font-weight="700" fill="var(--viz-on-pill,#ffffff)">n2</text>
  </g>
  ...
  <text x="648" y="204" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-on-pill,#ffffff)">G</text>
  <!-- annotation on n3 -->
...
<svg viewBox="0 0 780 322" role="img" aria-labelledby="aaTitle aaDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="aaTitle">A unit mismatch makes the heuristic overestimate, and A* stops being optimal</title>
  <desc id="aaDesc">The same node scored two ways against second-valued edge weights. With the Haversine distance divided by the maximum speed, h is 132 seconds — a true lower bound on the remaining time — so f stays below the cost of the optimal path and A star cannot settle the target early. With raw metres, h is 4,620, which dwarfs the 210-second g value; f is dominated by the heuristic, the search charges at the goal along whichever branch points most directly at it, and the target is settled on a straighter but slower route. The symptom is that A star and Dijkstra return different total costs for the same query.</desc>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="322" fill="var(--viz-bg,#ffffff)"/>
  <text x="24" y="24" font-size="13.5" font-weight="700" fill="currentColor">f = g + h, and h has to be in the same unit as g</text>
  <text x="24" y="42" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">node 4,620 m from the target · g = 210 s · edge weights are travel_s</text>
  <rect x="24" y="58" width="356" height="176" rx="10" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-good,#0a656d)" stroke-width="1.8"/>
  <text x="202" y="82" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-good,#0a656d)">haversine_m(…) / max_mps</text>
  <text x="202" y="99" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">a lower bound on remaining seconds</text>
  <text x="44" y="128" font-size="10.5" font-weight="700" fill="currentColor">g</text>
  <rect x="72" y="118" width="62" height="14" rx="7" fill="var(--accent-3,#5b21b6)"/>
  <text x="146" y="129" font-size="10" fill="var(--viz-ink-mute,#565f6d)">210 s</text>
  <text x="44" y="154" font-size="10.5" font-weight="700" fill="currentColor">h</text>
  <rect x="72" y="144" width="39" height="14" rx="7" fill="var(--viz-good,#0a656d)"/>
  <text x="146" y="155" font-size="10" fill="var(--viz-ink-mute,#565f6d)">132 s</text>
  <text x="44" y="180" font-size="10.5" font-weight="700" fill="currentColor">f</text>
  <rect x="72" y="170" width="101" height="14" rx="7" fill="var(--viz-stroke,#9ca3af)"/>
  <text x="186" y="181" font-size="10" fill="var(--viz-ink-mute,#565f6d)">342 s</text>
  <text x="202" y="212" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-good,#0a656d)">h never exceeds the true remaining cost</text>
  <text x="202" y="227" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">admissible — the first settle of the target is optimal</text>
  <rect x="400" y="58" width="356" height="176" rx="10" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-poor,#a8320f)" stroke-width="1.8"/>
  <text x="578" y="82" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-poor,#a8320f)">haversine_m(…)</text>
  <text x="578" y="99" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">metres, compared against seconds</text>
  <text x="420" y="128" font-size="10.5" font-weight="700" fill="currentColor">g</text>
  <rect x="448" y="118" width="14" height="14" rx="7" fill="var(--accent-3,#5b21b6)"/>
  <text x="474" y="129" font-size="10" fill="var(--viz-ink-mute,#565f6d)">210</text>
  <text x="420" y="154" font-size="10.5" font-weight="700" fill="currentColor">h</text>
  <rect x="448" y="144" width="290" height="14" rx="7" fill="var(--viz-poor,#a8320f)"/>
  <text x="420" y="180" font-size="10.5" font-weight="700" fill="currentColor">f</text>
  <rect x="448" y="170" width="290" height="14" rx="7" fill="var(--viz-stroke,#9ca3af)"/>
  <text x="578" y="212" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-poor,#a8320f)">h = 4,620 — twenty-two times g</text>
  <text x="578" y="227" text-anchor="middle" font-size="10" fill="var(--viz-ink-mute,#565f6d)">inadmissible — the ordering is the heuristic's alone</text>
  <text x="24" y="264" font-size="11" font-weight="700" fill="currentColor">what it looks like in production</text>
  <text x="24" y="282" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">A* returns a route. It is plausible, it is fast to compute, and its total cost is higher than Dijkstra's on the same</text>
  <text x="24" y="298" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">pair. Comparing the two costs on a sample of queries is the cheapest test that catches it.</text>
</svg>
