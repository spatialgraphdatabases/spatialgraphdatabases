...
<svg viewBox="0 0 780 392" role="img" aria-labelledby="ra-front-title ra-front-desc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <rect class="viz-backdrop" x="0" y="0" width="780" height="392" fill="var(--viz-bg,#ffffff)"/>
  ...
  <text x="150" y="213" text-anchor="middle" font-size="10" font-weight="700" fill="var(--viz-on-pill,#ffffff)">S</text>
  <circle cx="312" cy="210" r="9" fill="var(--accent-3,#5b21b6)"/>
  <text x="312" y="213" text-anchor="middle" font-size="10" font-weight="700" fill="var(--viz-on-pill,#ffffff)">D</text>
...
<svg viewBox="0 0 780 336" role="img" aria-labelledby="ra-dec-title ra-dec-desc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <g font-size="12" fill="currentColor">
    ...
    <text x="380" y="141" text-anchor="middle" fill="var(--viz-on-pill,#ffffff)">Contraction</text>
    <text x="380" y="158" text-anchor="middle" fill="var(--viz-on-pill,#ffffff)" font-size="10.5">hierarchies</text>
    ...
    <text x="660" y="141" text-anchor="middle" fill="var(--viz-on-pill,#ffffff)">A* point-to-point</text>
    <text x="660" y="158" text-anchor="middle" fill="var(--viz-on-pill,#ffffff)" font-size="10.5">goal-biased search</text>
    ...
    <text x="470" y="270" text-anchor="middle" fill="var(--viz-on-pill,#ffffff)" font-weight="700">Dijkstra (GDS at scale)</text>
    <text x="470" y="290" text-anchor="middle" fill="var(--viz-on-pill,#ffffff)" font-size="10.5">no heuristic, or one-to-many cost surfaces</text>
