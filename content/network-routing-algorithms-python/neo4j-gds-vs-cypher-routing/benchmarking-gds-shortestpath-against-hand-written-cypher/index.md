...
<svg viewBox="0 0 780 328" role="img" aria-labelledby="bhTitle bhDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="bhTitle">What each timing window includes, and the number it produces</title>
  <desc id="bhDesc">Four measurement windows over the same request. Twenty warm-up iterations run untimed so the page cache, plan cache and Bolt path settle. The cold GDS window brackets project, stream and drop as one unit, the cost a stateless request actually pays. The warm GDS window brackets stream alone and is only achievable if the projection stays resident. The Cypher window brackets its expansion over the same session and the same repetition count. Reported as p50 and p95 together, because cold GDS has a good median and a long tail that the median hides.</desc>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="328" fill="var(--viz-bg,#ffffff)"/>
  <text x="24" y="24" font-size="13.5" font-weight="700" fill="currentColor">The window you bracket is the number you publish</text>
  <rect x="24" y="42" width="180" height="38" rx="8" fill="var(--viz-panel-2,#ece9df)" stroke="var(--viz-stroke-soft,#cdc6b3)" stroke-width="1.2" stroke-dasharray="6 4"/>
  <text x="114" y="60" text-anchor="middle" font-size="11" font-weight="700" fill="var(--viz-ink-mute,#565f6d)">20 warm-up iterations</text>
  <text x="114" y="74" text-anchor="middle" font-size="9.5" fill="var(--viz-ink-mute,#565f6d)">untimed — discarded</text>
  <text x="224" y="66" font-size="10" fill="var(--viz-ink-mute,#565f6d)">page cache · plan cache · Bolt path all settle here</text>
  <rect x="24" y="98" width="732" height="62" rx="9" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-ok,#7d6200)" stroke-width="1.8"/>
  <text x="42" y="120" font-size="11.5" font-weight="700" fill="currentColor">GDS cold</text>
  <text x="42" y="137" font-size="9.5" fill="var(--viz-ink-mute,#565f6d)">what a stateless request pays</text>
  <rect x="212" y="110" width="150" height="26" rx="6" fill="var(--viz-ok,#7d6200)"/>
  <text x="287" y="127" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">project</text>
  <rect x="368" y="110" width="150" height="26" rx="6" fill="var(--viz-ok,#7d6200)"/>
  <text x="443" y="127" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">stream</text>
  <rect x="524" y="110" width="110" height="26" rx="6" fill="var(--viz-ok,#7d6200)"/>
  <text x="579" y="127" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">drop</text>
  <text x="423" y="152" text-anchor="middle" font-size="9.5" fill="var(--viz-ink-mute,#565f6d)">timed as one unit — omitting project and drop is the dishonest benchmark</text>
  <rect x="24" y="174" width="732" height="56" rx="9" fill="var(--viz-panel,#f4f4f5)" stroke="var(--viz-good,#0a656d)" stroke-width="1.8"/>
  <text x="42" y="196" font-size="11.5" font-weight="700" fill="currentColor">GDS warm</text>
  <text x="42" y="213" font-size="9.5" fill="var(--viz-ink-mute,#565f6d)">real only if the projection stays resident</text>
  <rect x="368" y="186" width="150" height="26" rx="6" fill="var(--viz-good,#0a656d)"/>
  <text x="443" y="203" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">stream</text>
  <rect x="24" y="244" width="732" height="56" rx="9" fill="var(--viz-panel,#f4f4f5)" stroke="var(--accent-3,#5b21b6)" stroke-width="1.8"/>
  <text x="42" y="266" font-size="11.5" font-weight="700" fill="currentColor">hand-written Cypher</text>
  <text x="42" y="283" font-size="9.5" fill="var(--viz-ink-mute,#565f6d)">same session, same reps, same draining</text>
  <rect x="368" y="256" width="150" height="26" rx="6" fill="var(--accent-3,#5b21b6)"/>
  <text x="443" y="273" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--viz-on-pill,#ffffff)">expansion</text>
  <text x="24" y="320" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">Everything outside the algorithm is held constant, so the difference between the bars is the algorithm.</text>
</svg>
