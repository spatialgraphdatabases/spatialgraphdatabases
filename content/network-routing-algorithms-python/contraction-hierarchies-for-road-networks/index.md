...
<svg viewBox="-44 0 864 430" role="img" aria-labelledby="chSearchTitle chSearchDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <!-- rank guide bands -->
  <rect class="viz-backdrop" x="-44" y="0" width="864" height="430" fill="var(--viz-bg,#ffffff)"/>
  ...
  <g>
    ...
    <text x="90" y="354" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-on-pill,#ffffff)">S</text>
  ...
  <g>
    ...
    <text x="730" y="354" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-on-pill,#ffffff)">T</text>
  ...
  <text x="410" y="108" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-on-pill,#ffffff)">M</text>
...
<svg viewBox="0 0 820 300" role="img" aria-labelledby="chSchemaTitle chSchemaDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <!-- shortcut arc -->
  <rect class="viz-backdrop" x="0" y="0" width="820" height="300" fill="var(--viz-bg,#ffffff)"/>
  ...
  <text x="150" y="155" text-anchor="middle" font-size="14" font-weight="700" fill="var(--viz-on-pill,#ffffff)">u</text>
  ...
  <text x="670" y="155" text-anchor="middle" font-size="14" font-weight="700" fill="var(--viz-on-pill,#ffffff)">w</text>
