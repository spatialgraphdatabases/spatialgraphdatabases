...
<svg viewBox="0 0 760 380" role="img" aria-labelledby="witTitle witDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  ...
  <rect class="viz-backdrop" x="0" y="0" width="760" height="380" fill="var(--viz-bg,#ffffff)"/>
  ...
  <!-- nodes -->
  <circle cx="70" cy="150" r="15" fill="var(--accent,#0a656d)"/><text x="70" y="154" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-on-pill,#ffffff)">u</text>
  <circle cx="320" cy="150" r="15" fill="var(--accent,#0a656d)"/><text x="320" y="154" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-on-pill,#ffffff)">w</text>
  ...
  <circle cx="195" cy="255" r="15" fill="var(--accent-4,#b58900)"/><text x="195" y="259" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-on-pill,#ffffff)">v</text>
  ...
  <g transform="translate(390,0)">
    ...
    <rect x="112" y="266" width="166" height="42" rx="9" fill="var(--surface-2,#fff)" stroke="var(--accent-3,#5b21b6)" stroke-width="1.6"/>
    <text x="195" y="284" text-anchor="middle" font-size="12" font-weight="700" fill="var(--accent-3,#5b21b6)">:SHORTCUT</text>
    <text x="195" y="300" text-anchor="middle" font-size="10.5" fill="currentColor">weight 7 · via v</text>
    <!-- nodes -->
    <circle cx="70" cy="150" r="15" fill="var(--accent,#0a656d)"/><text x="70" y="154" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-on-pill,#ffffff)">u</text>
    <circle cx="320" cy="150" r="15" fill="var(--accent,#0a656d)"/><text x="320" y="154" text-anchor="middle" font-size="12" font-weight="700" fill="var(--viz-on-pill,#ffffff)">w</text>
    <circle cx="195" cy="60" r="13" fill="var(--surface-2,#fff)" stroke="currentColor" stroke-width="1.8"/><text x="195" y="64" text-anchor="middle" font-size="11" font-weight="700" fill="currentColor">x</text>
...
<svg viewBox="0 0 780 340" role="img" aria-labelledby="ceTitle ceDesc" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:var(--font-sans,sans-serif)">
  <title id="ceTitle">Contracting a hub early is what makes the shortcut count run away</title>
  <desc id="ceDesc">Shortcut count plotted against nodes contracted for two orderings of the same graph. With a lazily recomputed edge-difference priority, low-degree nodes contract first and the count grows close to linearly, ending near 1.4 shortcuts per contracted node. With a hub contracted early, that one node creates a near-complete bipartite set of shortcuts among its neighbours, which raises everyone else's edge difference and creates still more, so the curve bends sharply upward and crosses the four-times tripwire before half the graph is contracted.</desc>
  <rect class="viz-backdrop" x="0" y="0" width="780" height="340" fill="var(--viz-bg,#ffffff)"/>
  <text x="24" y="24" font-size="13.5" font-weight="700" fill="currentColor">Shortcuts created as contraction proceeds</text>
  <text x="24" y="42" font-size="10.5" fill="var(--viz-ink-mute,#565f6d)">same graph, two contraction orders</text>
  <line x1="92" y1="66" x2="92" y2="272" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.4"/>
  <line x1="92" y1="272" x2="736" y2="272" stroke="var(--viz-stroke,#9ca3af)" stroke-width="1.4"/>
  <g font-size="9.5" fill="var(--viz-ink-mute,#565f6d)" text-anchor="end">
    <text x="84" y="270">0</text><text x="84" y="219">2×</text><text x="84" y="168">4×</text><text x="84" y="117">6×</text><text x="84" y="70">8×</text>
  </g>
  <text x="30" y="176" font-size="10" font-weight="700" fill="currentColor" transform="rotate(-90 30 176)">shortcuts / node</text>
  <g font-size="9.5" fill="var(--viz-ink-mute,#565f6d)" text-anchor="middle">
    <text x="92" y="290">0%</text><text x="253" y="290">25%</text><text x="414" y="290">50%</text><text x="575" y="290">75%</text><text x="736" y="290">100%</text>
  </g>
  <text x="414" y="308" text-anchor="middle" font-size="10" font-weight="700" fill="currentColor">nodes contracted</text>
  <line x1="92" y1="168" x2="736" y2="168" stroke="var(--viz-poor,#a8320f)" stroke-width="1.4" stroke-dasharray="6 5"/>
  <text x="732" y="162" text-anchor="end" font-size="9.5" font-weight="700" fill="var(--viz-poor,#a8320f)">tripwire: 4 × contracted</text>
  <path d="M92 272 L253 258 L414 246 L575 236 L736 226" fill="none" stroke="var(--viz-good,#0a656d)" stroke-width="2.6"/>
  <path d="M92 272 L172 250 L253 214 L334 170 L414 118 L495 84 L575 74 L736 70" fill="none" stroke="var(--viz-poor,#a8320f)" stroke-width="2.6" stroke-dasharray="8 5"/>
  <circle cx="253" cy="214" r="5" fill="var(--viz-poor,#a8320f)"/>
  <line x1="253" y1="209" x2="300" y2="150" stroke="var(--viz-poor,#a8320f)" stroke-width="1.2"/>
  <text x="306" y="146" font-size="10" font-weight="700" fill="var(--viz-poor,#a8320f)">one degree-40 hub contracted here</text>
  <text x="306" y="160" font-size="9.5" fill="var(--viz-ink-mute,#565f6d)">~800 shortcuts among its neighbours in one step</text>
  <rect x="92" y="316" width="14" height="6" rx="3" fill="var(--viz-good,#0a656d)"/>
  <text x="114" y="322" font-size="10" fill="currentColor">lazy edge-difference priority — ends at 1.4×</text>
  <rect x="392" y="316" width="14" height="6" rx="3" fill="var(--viz-poor,#a8320f)"/>
  <text x="414" y="322" font-size="10" fill="currentColor">hub contracted early — crosses the tripwire at 42%</text>
</svg>
